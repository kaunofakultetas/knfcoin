...
/*
    Source: https://www.completenoobs.com/noobs/N33Bcoin_0.0.1

    
    KNF Coin Genesis Block:

    docker run --rm vuknf/genesis-generator python genesis.py -a scrypt -z "VU KNF - Fintech Studijų Programa (2025-09-20)" -v 5000000000 -t 1759089786 -n 198580 -b 0x1e0ffff0
    04ffff001d01042f5655204b4e46202d2046696e746563682053747564696ac5b32050726f6772616d612028323032352d30392d323029
    algorithm: scrypt
    merkle hash: 690fb8eafb6871d4720b9fa75fffa4a5aac438d80794100e8f6acbcb0b8f6fe6
    pszTimestamp: VU KNF - Fintech Studijų Programa (2025-09-20)
    ...
    genesis hash found!
    nonce: 515791
    genesis hash: 8099b90883632e7d02c47ee23d9a02b980c61285d67289bd935e4c1b8f73d5ea
*/
...
{
    const char* pszTimestamp = "VU KNF - Fintech Studijų Programa (2025-09-20)";
...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 0; // Activate immediately from genesis
        consensus.BIP34Height = 0; // Activate immediately from genesis
        consensus.BIP34Hash = uint256S("0x8099b90883632e7d02c47ee23d9a02b980c61285d67289bd935e4c1b8f73d5ea");
        consensus.BIP65Height = 0; // Activate immediately from genesis
        consensus.BIP66Height = 0; // Activate immediately from genesis
        consensus.CSVHeight = 0; // Activate immediately from genesis (BIP112, BIP113, BIP68)
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 0; // Activate immediately from genesis
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 9999999999; // Never timeout

        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 0; // Activate immediately from genesis
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 9999999999; // Never timeout

        consensus.nMinimumChainWork = uint256S("0x00");
        consensus.defaultAssumeValid = uint256S("0x8099b90883632e7d02c47ee23d9a02b980c61285d67289bd935e4c1b8f73d5ea"); // 0
        ...
        genesis = CreateGenesisBlock(1759089786, 515791, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8099b90883632e7d02c47ee23d9a02b980c61285d67289bd935e4c1b8f73d5ea"));
        assert(genesis.hashMerkleRoot == uint256S("0x690fb8eafb6871d4720b9fa75fffa4a5aac438d80794100e8f6acbcb0b8f6fe6"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x8099b90883632e7d02c47ee23d9a02b980c61285d67289bd935e4c1b8f73d5ea")}
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 10
            /* nTime    */ 1759842677,
            /* nTxCount */ 12,
            /* dTxRate  */ 0.003898635477582846
        };
    }
};
...
/*
    KNF Coin Genesis Block (Testnet3):
...
/*
    KNF Coin Genesis Block (Regtest):

    docker run --rm vuknf/genesis-generator python genesis.py -a scrypt -z "VU KNF - Fintech Studijų Programa (2025-09-20)"     -v 5000000000 -t 1759089786 -n 198580 -b 0x207fffff
    04ffff001d01042f5655204b4e46202d2046696e746563682053747564696ac5b32050726f6772616d612028323032352d30392d323029
    algorithm: scrypt
    merkle hash: 690fb8eafb6871d4720b9fa75fffa4a5aac438d80794100e8f6acbcb0b8f6fe6
    pszTimestamp: VU KNF - Fintech Studijų Programa (2025-09-20)
    ...
    genesis hash found!
    nonce: 198580
    genesis hash: 3b1373a37308f3bb4cbd5c8529f4ddabfe927143da31cfeb7e355dd0feeba1e8
*/
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1759089786, 198580, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3b1373a37308f3bb4cbd5c8529f4ddabfe927143da31cfeb7e355dd0feeba1e8"));
        assert(genesis.hashMerkleRoot == uint256S("0x690fb8eafb6871d4720b9fa75fffa4a5aac438d80794100e8f6acbcb0b8f6fe6"));
        ...
        checkpointData = {
            {
                {0, uint256S("3b1373a37308f3bb4cbd5c8529f4ddabfe927143da31cfeb7e355dd0feeba1e8")},
            }
        };
